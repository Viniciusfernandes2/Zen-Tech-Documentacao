...
const Header: React.FC = () => {
  ...
  // Busca o nome do usuário no localStorage, ou usa "visitante"
  const nomeUsuario = localStorage.getItem("@Auth:name") || "visitante";
    ...
    <header className="header">
      <nav className="navContainer">
        ...
        <ul className="navListRight">
          {/* Saudação */}
          <li>
            <p className="saudacao-header">Olá, {nomeUsuario}</p>
          </li>
